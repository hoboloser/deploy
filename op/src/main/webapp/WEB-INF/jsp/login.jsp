...
<body style="font-family: 'Roboto', 'Droid Sans Fallback', '微软雅黑';min-height: 100vh;display: flex;flex-direction: column;">
	...
	<nav>
		<div class="nav-wrapper">
			<a href="${pageContext.request.contextPath}/" class="brand-logo center">Auto Deploy</a>
		</div>
	</nav>

	<div class="container" style="padding-top: 20px; width: 90%;flex: 1 0 auto;">
		<div class="row">
			<form class="col s12 m12 l4 offset-l4" action="${pageContext.request.contextPath}/opc/login" method="post">
				<div class="card">
					<div class="card-content">
						<span class="card-title grey-text">登录</span>
						<c:if test="${not empty errorMsg}"><div class="red-text">用户名或密码错误！</div></c:if>
						<div class="row">
	...
	<footer class="page-footer" style="padding-top: 0; margin-top: 40px;">
      <div class="footer-copyright">
        <div class="container">
        Copyright © 2017  lsnBin . All rights reserved.
        </div>
      </div>
    </footer>
